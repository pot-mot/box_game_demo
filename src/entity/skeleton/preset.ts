...
export const buildCharacterSkeletonDefinition = (): SkeletonDefinition => {
    ...
    const legH = MODEL_BASE_HEIGHT * LEG_RATIO
    const hipH = legH / 2
    const shinH = legH / 2
    ...
    return {
        joints: [
            ...
            {id: 'spine', name: '躯干', parentId: 'root', position: [0, 0, 0], rotation: identity},
            ...
            {id: 'rightLegHip', name: '右髋', parentId: 'root', position: [hipX, 0, 0], rotation: identity},
            ...
            {id: 'leftLegHip', name: '左髋', parentId: 'root', position: [-hipX, 0, 0], rotation: identity},
        ...
        bones: [
            {id: 'torso', name: '躯干', headJointId: 'root', tailJointId: 'spine', length: 0, roll: 0},
            {id: 'neck', name: '颈部', headJointId: 'spine', tailJointId: 'headNeck', length: bodyH, roll: 0},
...
export const PRESET_PART_SIZES = {
    ...
    thighH: MODEL_BASE_HEIGHT * LEG_RATIO / 2,
    shinH: MODEL_BASE_HEIGHT * LEG_RATIO / 2,
} as const